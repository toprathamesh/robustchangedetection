...
BASE_DIR = Path(__file__).resolve().parent.parent  # src/web/
PROJECT_ROOT = BASE_DIR.parent  # src/
WORKSPACE_ROOT = PROJECT_ROOT.parent  # project root
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Robust Change Detection API',
    'DESCRIPTION': 'API for satellite imagery change detection',
    'VERSION': '1.0.0',
...
SENTINEL_HUB_INSTANCE_ID = config('SENTINEL_HUB_INSTANCE_ID', default='')

USGS_USERNAME = config('USGS_USERNAME', default='')
USGS_PASSWORD = config('USGS_PASSWORD', default='')
